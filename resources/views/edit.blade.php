    ...
    <form class="row g-3" action="{{ route('thing.update') }}" method="post">
        ...
        <div class="col-lg-6 offset-lg-3">
            ...
            <textarea class="form-control @error('thing') is-invalid @enderror" aria-describedby="validate" name="thing"
                id="thing" cols="30" rows="5" placeholder="デキゴトを入力">{{ old('thing', $thing->thing) }}</textarea>
            @error('thing')
        ...
        <div class="col-lg-6 offset-lg-3">
            ...
            <textarea class="form-control @error('bad_thing_workaround') is-invalid @enderror" aria-describedby="validate"
                name="bad_thing_workaround" id="bad_thing_workaround" cols="30" rows="10" placeholder="タイサクを入力">{{ old('bad_thing_workaround', $thing->bad_thing_workaround) }}</textarea>
